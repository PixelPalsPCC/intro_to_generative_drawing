//from https://adamherst.art/introduction_to_generative_drawing_letter.pdf
//view at https://editor.p5js.org/georgemck/sketches/OWpA2hlep
...
function setup() {
    ...
    print(random()); // Introducing Variability into the Sketches   print(random(10)); // Introducing Variability into the Sketches
...
function draw() {
    ...
    // rect(random(width), random(height), random(squareWidth), random(squareHeight)); 
